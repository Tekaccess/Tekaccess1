            ...
            <div className="relative min-h-[500px] bg-slate-100 overflow-hidden">
              ...
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-full">
                <div className="relative">
                  <div className="h-14 w-14 rounded-full bg-[#0A1437] flex items-center justify-center shadow-2xl animate-bounce">
                    <MapPin className="h-7 w-7 text-white" />
                  </div>
                  <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 h-6 w-6 rotate-45 bg-[#0A1437]" />
                </div>
              </div>
            </div>
