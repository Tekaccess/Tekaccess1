...
const AboutUs = () => {
  ...
  return (
    <section id="about" className="relative overflow-hidden bg-white">
      ...
      <div className="relative bg-slate-50 py-20 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-8 border-b border-slate-100">
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="space-y-8 text-center lg:text-left">
              <div>
                <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 leading-tight tracking-tight mb-8">
              ...
              <div className="space-y-6">
                ...
                <p className="text-slate-500 text-lg leading-relaxed max-w-2xl mx-auto lg:mx-0 font-light">
              ...
              <div className="pt-4">
                <a 
                  href="#contact" 
                  className="inline-flex items-center gap-3 bg-primary hover:bg-primary/90 text-white px-8 py-4 rounded-full font-bold transition-all hover:translate-x-1 shadow-lg shadow-primary/20"
                >
                  PARTNER WITH US
      ...
      <div className="relative py-20 lg:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden bg-white">
        <div className="relative mx-auto max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            {/* Left - Image */}
            <div className="relative">
               <div className="relative overflow-hidden rounded-2xl shadow-xl transform -rotate-2 border border-slate-100">
                <img
                  src={aboutMaterials}
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-6">Our Story</h3>
              ...
              <div className="grid sm:grid-cols-2 gap-8 pt-4">
                <div className="p-8 bg-slate-50 rounded-2xl border border-slate-100 shadow-sm">
                  <p className="text-primary font-bold text-xs tracking-widest uppercase mb-4">Vision</p>
                ...
                <div className="p-8 bg-slate-50 rounded-2xl border border-slate-100 shadow-sm">
                  <p className="text-primary font-bold text-xs tracking-widest uppercase mb-4">Mission</p>
                  <p className="text-slate-800 leading-relaxed text-sm">
      ...
      {/* Core Values Section */}
      <div className="relative bg-slate-50 py-24 px-4 sm:px-6 lg:px-8 border-y border-slate-100">
        <div className="relative mx-auto max-w-7xl">
          <div className="text-center mb-20">
            <h3 className="text-3xl sm:text-5xl font-extrabold text-slate-900 mb-6 leading-tight">Our Core Values</h3>
            <p className="text-slate-600 text-lg max-w-2xl mx-auto font-light">
              The heart of our organization, guiding every decision and action we take.
            </p>
            <div className="mt-8 h-1.5 w-24 bg-primary mx-auto rounded-full" />
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {coreValues.map((value, index) => (
              <div key={index} className="group p-10 bg-white rounded-3xl border border-slate-100 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-primary/5">
                <div className="mb-6 p-4 bg-primary/10 rounded-2xl inline-block group-hover:bg-primary group-hover:scale-110 transition-all duration-300">
            ...
            {/* Last one takes up remaining space if needed or just centered */}
