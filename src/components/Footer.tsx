      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="grid gap-16 md:grid-cols-3 lg:gap-24">
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-600 font-light leading-relaxed max-w-xs">
              Empowering global trade with innovative logistics solutions,
              precision analytics, and unwavering reliability.
            </p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-4">
              {[
                ...
                {
                  icon: Linkedin,
                  href: "https://www.linkedin.com/company/tekaccess-ltd?originalSubdomain=rw",
                  label: "LinkedIn",
                },
                {
                  icon: Instagram,
        ...
        <div className="mt-20 pt-10 border-t border-slate-100 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-8">
            <button className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em] hover:text-primary transition-colors">
              Privacy Policy
            </button>
            <button className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em] hover:text-primary transition-colors">
              Terms of Service
